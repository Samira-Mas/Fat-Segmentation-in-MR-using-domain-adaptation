...
def trainGenerator(batch_size,train_path,validation_path,aug_dict,image_color_mode = "grayscale",
...
def testGenerator(test_path,mask_path,num_image = 60,target_size = (256,256),flag_multi_class = False,as_gray = True):
