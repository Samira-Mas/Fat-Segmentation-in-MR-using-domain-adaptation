...
def make_dataset(img_paths, batch_size, size, training, drop_remainder=True, shuffle=True, repeat=1):
    ...
    return utils.disk_image_batch_dataset(img_paths,
                                       batch_size,
...
def make_zip_dataset(A_img_paths, B_img_paths, batch_size, size,  training, shuffle=True, repeat=False):
    ...
    if training:
        ...
        A_B_dataset = make_dataset(A_img_paths, batch_size, size, training, drop_remainder=True, shuffle=shuffle, repeat=None)
        len_dataset = len(A_img_paths)
